...
Namespace ParameterLookUpWindowsFormsApplication
    ...
    Public Partial Class Form1
        ...
        Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            CType(parameter1.LookUpSettings, StaticListLookUpSettings).LookUpValues.AddRange(New LookUpValue() {New LookUpValue(1, "Beverages"), New LookUpValue(2, "Condiments"), New LookUpValue(3, "Confections")})
